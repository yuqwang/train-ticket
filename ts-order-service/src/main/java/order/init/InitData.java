...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args)throws Exception{
        ...
        order.setAccountId(UUID.fromString(accountId).toString());
        ...
        orderTwo.setAccountId(UUID.fromString(accountId).toString());
        ...
        orderThree.setAccountId(UUID.fromString(accountId).toString());
