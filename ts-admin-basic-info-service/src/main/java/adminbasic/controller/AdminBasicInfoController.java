...
public class AdminBasicInfoController {
    ...
    public HttpEntity getAllConfigs(@RequestHeader HttpHeaders headers) {
        ...
        try {
            ...
            AdminBasicInfoController.LOGGER.error("request for getting all configs denied:" + e.toString());
    ...
    public HttpEntity getAllPrices(@RequestHeader HttpHeaders headers) {
        ...
        try {
            ...
            AdminBasicInfoController.LOGGER.error("request for getting all prices denied:" + e.toString());
            return status(500).build();
        }
    }
