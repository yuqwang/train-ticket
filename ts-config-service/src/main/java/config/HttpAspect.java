...
public class HttpAspect {
    ...
    @Pointcut("execution(public * config.controller.*.*(..))")
    public void webLog() {
    }
    ...
    @AfterThrowing(value = "execution(public * config.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * config.MockLog.printLog(..))")
