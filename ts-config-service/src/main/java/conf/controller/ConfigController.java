...
public class ConfigController {
    ...
    @CrossOrigin(origins = "*")
    @RequestMapping(value= "/conf/create", method = RequestMethod.POST)
    ...
    @CrossOrigin(origins = "*")
    @RequestMapping(value= "/conf/retrieve", method = RequestMethod.POST)
    ...
    @CrossOrigin(origins = "*")
    @RequestMapping(value= "/conf/query", method = RequestMethod.POST)
    ...
    @CrossOrigin(origins = "*")
    @RequestMapping(value= "/conf/queryAll", method = RequestMethod.GET)
