...
public class UserServiceImplTest {
    ...
    public void testFindByUserId1() {
        ...
        User user = new User();
        Mockito.when(userRepository.findByUserId(Mockito.any(String.class))).thenReturn(user);
    ...
    public void testFindByUserId2() {
        UUID userId = UUID.randomUUID();
        Mockito.when(userRepository.findByUserId(Mockito.any(String.class))).thenReturn(null);
        Response result = userServiceImpl.findByUserId(userId.toString(), headers);
        Assert.assertEquals(new Response<>(0, "No User", null), result);
    }
    ...
    public void testDeleteUser1() {
        ...
        Mockito.doNothing().doThrow(new RuntimeException()).when(userRepository).deleteByUserId(Mockito.any(String.class));
