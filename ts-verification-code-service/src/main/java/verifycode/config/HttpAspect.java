...
public class HttpAspect {
    ...
    @Pointcut("execution(public * verifycode.controller.*.*(..))")
    public void webLog() {
    }
    ...
    @AfterThrowing(value = "execution(public * verifycode.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * verifycode.config.MockLog.printLog(..))")
