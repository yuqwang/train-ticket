...
public class ContactsControllerTest {
    ...
    public void testDeleteContacts() throws Exception {
        ...
        Mockito.when(contactsService.delete(Mockito.any(String.class), Mockito.any(HttpHeaders.class))).thenReturn(response);
    ...
    public void testFindContactsByAccountId() throws Exception {
        ...
        Mockito.when(contactsService.findContactsByAccountId(Mockito.any(String.class), Mockito.any(HttpHeaders.class))).thenReturn(response);
    ...
    public void testGetContactsByContactsId() throws Exception {
        ...
        Mockito.when(contactsService.findContactsById(Mockito.any(String.class), Mockito.any(HttpHeaders.class))).thenReturn(response);
