...
public class RoutePlanServiceImpl implements RoutePlanService {
    ...
    public Response searchCheapestResult(RoutePlanInfo info, HttpHeaders headers) {
        ...
        // ArrayList<TripResponse> highSpeed =
        // getTripFromHighSpeedTravelServive(queryInfo, headers);
        // ArrayList<TripResponse> normalTrain =
        // getTripFromNormalTrainTravelService(queryInfo, headers);
    ...
    public Response searchQuickestResult(RoutePlanInfo info, HttpHeaders headers) {
        ...
        // for (int j = 0; j < finalResult.size(); j++) {
        // TripResponse thisRes = finalResult.get(j);
        // if (thisRes.getEndTime().getTime() - thisRes.getStartingTime().getTime() <
        // minTime) {
        // minTime = thisRes.getEndTime().getTime() -
        // thisRes.getStartingTime().getTime();
        // minIndex = j;
        // }
        // }
        // returnResult.add(finalResult.get(minIndex));
    ...
    public Response searchMinStopStations(RoutePlanInfo info, HttpHeaders headers) {
        ...
        // "http://ts-route-service:11178/api/v1/routeservice/routes/" + fromStationId +
        // "/" + toStationId,
        // HttpMethod.GET,
        // requestEntity,
        ...
        // RoutePlanServiceImpl.LOGGER.info("Candidate Route Number: {}",
        // routeList.size());
        ...
        // }
        // // 4.Depending on the route, go to travel-service or travel2service to get
        // the
        // // train information
        ...
        // 5.Then, get the price and the station information according to the train
        // information
