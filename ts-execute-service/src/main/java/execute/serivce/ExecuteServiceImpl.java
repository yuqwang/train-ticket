...
public class ExecuteServiceImpl implements ExecuteService {
    ...
    @Override
    public Response ticketCollect(String orderId, HttpHeaders headers) throws ExecutionException, InterruptedException {
        //1.Get order information
...
//        Response<Order> resultFromOrder = getOrderByIdFromOrder(orderId, headers);
        // 2. execute order
        Future<Response> executeOrderFuture = asyncTask.executeOrder(orderId, OrderStatus.COLLECTED.getCode(), headers);
